...
ActiveRecord::Schema.define(:version => 20131122150225) do
  ...
  create_table "students", :force => true do |t|
    ...
    t.string   "admit_status"
    t.string   "admit_type"
    t.string   "recommended_appeal_status"
  end
  ...
  create_table "terms", :force => true do |t|
    ...
    t.datetime "created_at",                     :null => false
    t.datetime "updated_at",                     :null => false
    t.string   "probation_term"
    t.integer  "total_undergraduate_enrollment"
  end
